...
-- MAGIC %md
-- MAGIC Reviewing the table history shows a previous version of this table was replaced. The version 0 CRAS statement was when the `Classroom-Setup` script was run. The version 1 CRAS statement was run in the previous cell.
